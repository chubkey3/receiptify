...
namespace webapi.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ReceiptifyContext context)
        {
            ...
            var receipt3 = new Receipt { ReceiptId = 3, ReceiptUrl = "https://miro.medium.com/v2/resize:fit:400/1*MLRlL9W69PMWAcTF-rV36Q.jpeg", UploadDate = new DateTime(2025, 6, 15, 10, 30, 0), UploadedBy = "Ok6yVBpq1WcgMac4ycOGtdmmZtZ2" };
