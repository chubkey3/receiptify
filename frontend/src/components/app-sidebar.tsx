...
export function AppSidebar({ analyticsMutate, expensesMutate, ...props }: AppSidebarProps) {
  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
      ...
      <SidebarContent>
        <NavMain analyticsMutate={analyticsMutate} expensesMutate={expensesMutate} items={data.navMain} />
        {/**<NavDocuments items={data.documents} />**/}
        {/**<NavSecondary items={data.navSecondary} className="mt-auto" />**/}
      </SidebarContent>
      <SidebarFooter>
        <NavUser user={{name: user.data?.username ?? "", email: user.data?.email ?? "", avatar: ""}} />
      </SidebarFooter>
    </Sidebar>
  )
}
