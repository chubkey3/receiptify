...
export default function Page() {
  ...
  const { data, error, isLoading, mutate } = useSWR<{value: Summary}>('/analytics/summary', fetcher);
  ...
  return (
    ...
    >
      <AppSidebar variant="inset" analyticsMutate={mutate} expensesMutate={expenses.mutate} />
      <SidebarInset>
        <SiteHeader />
